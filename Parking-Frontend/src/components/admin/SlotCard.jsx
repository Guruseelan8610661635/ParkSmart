  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-2 gap-1.5">
        <button
          onClick={() => onEdit(slot)}
          className="bg-slate-700 hover:bg-slate-800 text-white px-2 py-1.5 rounded text-[9px] font-medium transition"
        >
          ✏️ Edit
        </button>
        ...
        {slot.isDisabled ? (
          <button
            ...
            className="bg-emerald-600 hover:bg-emerald-700 text-white px-2 py-1.5 rounded text-[9px] font-medium transition"
          >
            ✅ Enable
          </button>
        ) : (
          <button
            ...
            className="bg-amber-500 hover:bg-amber-600 text-white px-2 py-1.5 rounded text-[9px] font-medium transition"
          >
            🔧 Disable
          </button>
        )}
        ...
        <button
          ...
          className="bg-amber-400 hover:bg-amber-500 text-white px-2 py-1.5 rounded text-[9px] font-medium transition"
        >
          🔄 Toggle
        </button>
        <button
          onClick={() => onDelete(slot.id)}
          className="bg-rose-600 hover:bg-rose-700 text-white px-2 py-1.5 rounded text-[9px] font-medium transition"
        >
          🗑️ Delete
        </button>
      </div>
